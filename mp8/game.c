...
/*
Code for the main functions of the moving the number tiles and setting the board for the 2048 game.
Game begins with a random tile being assigned a random location and number of either 2 or 4.
The player controls the movement of the tiles using the W,A,S,D keys on the keyboard.
When two of the same valued tiles collide when moved, they combined to created a single tile worth double the value.
The game ends when no more valid moves can be played in any of the four directions (four functions for four directions).
*/
 ...
 */
{
    ...
    for (int y = 0; y < height; y ++) {
        for (int x = 0; x < width; x ++) {
            ...
            cell* right = get_cell(cur_game, y, x + 1);     //    adjacent cell.  If these are null,
